...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SHAMUACTIVE)
extern struct cpufreq_governor cpufreq_gov_shamuactive;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_shamuactive)
